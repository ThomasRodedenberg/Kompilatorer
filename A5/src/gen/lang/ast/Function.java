...
/**
 * @ast node
 * @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/lang.ast:3
...
public class Function extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect Visitor
   * @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/Visitor.jrag:47
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/PrettyPrint.jrag:19
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/Interpreter.jrag:16
   */
...
protected ASTState.Cycle reachable_cycle = null;
  ...
  @ASTNodeAnnotation.Source(aspect="Reachability", declaredAt="/h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/FunctionCalls.jrag:31")
...
protected java.util.Set localLookup_String_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/NameAnalysis.jrag:43
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/NameAnalysis.jrag:43")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/NameAnalysis.jrag:34
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/NameAnalysis.jrag:34")
...
protected java.util.Set lookup_String_visited;
  ...
  public IdDecl Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getNameNoTransform()) {
      // @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/NameAnalysis.jrag:35
      {
      		return lookup(name);
      	}
    }
  ...
  public boolean Define_isVariable(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getParameterListNoTransform()) {
      // @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/TypeAnalysis.jrag:147
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return true;
    }
    else if (_callerNode == getNameNoTransform()) {
      // @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/TypeAnalysis.jrag:143
      return false;
    }
    else {
  ...
  public boolean Define_isFunction(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getParameterListNoTransform()) {
      // @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/TypeAnalysis.jrag:148
      int childIndex = _callerNode.getIndexOfChild(_childNode);
      return false;
    }
    else if (_callerNode == getNameNoTransform()) {
      // @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/TypeAnalysis.jrag:144
      return true;
    }
    else {
...
protected boolean Function_functionCalls_visited = false;
  ...
  @ASTNodeAnnotation.Source(aspect="FunctionCalls", declaredAt="/h/d2/c/fte13tro/Documents/EDAN65/A5/MinimalAST/src/jastadd/FunctionCalls.jrag:7")
