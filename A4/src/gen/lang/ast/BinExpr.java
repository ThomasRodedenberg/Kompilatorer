...
/**
 * @ast node
 * @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A4/A4-MinimalAST/src/jastadd/lang.ast:19
...
public abstract class BinExpr extends Expr implements Cloneable {
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d2/c/fte13tro/Documents/EDAN65/A4/A4-MinimalAST/src/jastadd/Errors.jrag:70
    if (type() == unknownType()) {
      {
  ...
  protected void contributeTo_Program_errors(Set<ErrorMessage> collection) {
    ...
    if (type() == unknownType()) {
      collection.add(error("Expr type mistmatch!"));
    }
  }
}
